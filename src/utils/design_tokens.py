...
class DesignTokens:
    ...
    SELECTION_COLORS = {
        ...
        'orange': {'primary': '#FFA500', 'label': 'Orange'},
        'purple': {'primary': '#800080', 'label': 'Purple'},
        'brown': {'primary': '#A52A2A', 'label': 'Brown'},
        'pink': {'primary': '#FFC0CB', 'label': 'Pink'},
        'lime': {'primary': '#00FF00', 'label': 'Lime'},
        'indigo': {'primary': '#4B0082', 'label': 'Indigo'},
        'teal': {'primary': '#008080', 'label': 'Teal'},
        'navy': {'primary': '#000080', 'label': 'Navy'},
        'gray': {'primary': '#808080', 'label': 'Gray'},
